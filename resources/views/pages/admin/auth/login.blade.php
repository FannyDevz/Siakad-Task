...
<head>
  ...
  <title>Login | SMK Bhakti Mulia Pare</title>
  <link rel="shortcut icon" href="{{url('../../foto/10035.png')}}">
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="bg-atas text-center mb-4">
                    <img src="{{url('../../foto/10035.png')}}" alt="">
                  </div>
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 ">Sistem Informasi Akademik</h1>
                    <h1 class="h3 text-gray-900 mb-5">SMK Bhakti Mulia Pare</h1>
